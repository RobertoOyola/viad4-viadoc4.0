...
public partial class FacturacionElectronicaQaContext : DbContext
{
    ...
    public virtual DbSet<Facturaprueba> Facturapruebas { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=VMT-LCAIZEDO;Initial Catalog=FacturacionElectronicaQA;Integrated Security=True; TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CompRetencion>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_CompRetencion_Indice");
        ...
        modelBuilder.Entity<CompRetencionDetalle>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_CompRetencionDetalle_Indice");
        ...
        modelBuilder.Entity<CompRetencionDocSustento>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_CompRetencionDocSustento_Indice");
        ...
        modelBuilder.Entity<CompRetencionFormaPago>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_CompRetencionFormaPago_Indice");
        ...
        modelBuilder.Entity<CompRetencionInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_CompRetencionInfoAdicional_Indice");
        ...
        modelBuilder.Entity<ErrorEnvioEmail>(entity =>
        {
            ...
            entity.Property(e => e.TxClaveAcceso)
                ...
                .IsUnicode(false)
                .HasColumnName("txClaveAcceso");
            entity.Property(e => e.TxFechaError).HasColumnName("txFechaError");
            entity.Property(e => e.TxMensajeError)
                .HasMaxLength(250)
                .IsUnicode(false)
                .HasColumnName("txMensajeError");
        ...
        modelBuilder.Entity<Factura1>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_Factura_Indice");
        ...
        modelBuilder.Entity<FacturaDetalle1>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaDetalle_Indice");
        ...
        modelBuilder.Entity<FacturaDetalleAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaDetalleAdicional_Indice");
        ...
        modelBuilder.Entity<FacturaDetalleFormaPago1>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaDetalleFormaPago_Indice");
        ...
        modelBuilder.Entity<FacturaDetalleImpuesto1>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaDetalleImpuesto_Indice");
        ...
        modelBuilder.Entity<FacturaInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaInfoAdicional_Indice");
        ...
        {
            entity.HasKey(e => e.CiReembolso).HasName("PK__FacturaR__E995088870208B21");

            entity.ToTable("FacturaReembolsoGasto");

            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaReembolsoGasto_Indice");
        ...
        modelBuilder.Entity<FacturaTotalImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_FacturaTotalImpuesto_Indice");

            entity.HasIndex(e => e.TxSecuencial, "idx_FacturaTotalImpuestos_txSecuencial");
        ...
        modelBuilder.Entity<Facturaprueba>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("facturaprueba");

            entity.Property(e => e.CiCompania).HasColumnName("ciCompania");
            entity.Property(e => e.CiContingenciaDet).HasColumnName("ciContingenciaDet");
            entity.Property(e => e.CiEstado)
                .HasMaxLength(4)
                .IsUnicode(false)
                .IsFixedLength()
        ...
        modelBuilder.Entity<GuiaRemision>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_GuiaRemision_Indice");
        ...
        modelBuilder.Entity<GuiaRemisionDestinatario>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_GuiaRemisionDestinatario_Indice");
        ...
        modelBuilder.Entity<GuiaRemisionDestinatarioDetalle>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_GuiaRemisionDestinatarioDetalle_Indice");
        ...
        modelBuilder.Entity<GuiaRemisionDestinatarioDetalleAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_GuiaRemisionDestinatarioDetalleAdicional_Indice");
        ...
        modelBuilder.Entity<GuiaRemisionInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_GuiaRemisionInfoAdicional_Indice");
        ...
        modelBuilder.Entity<Liquidacion>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_Liquidacion_Indice");
        ...
        modelBuilder.Entity<LiquidacionDetalle>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionDetalle_Indice");
        ...
        modelBuilder.Entity<LiquidacionDetalleAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionDetalleAdicional_Indice");
        ...
        modelBuilder.Entity<LiquidacionDetalleFormaPago>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionDetalleFormaPago_Indice");
        ...
        modelBuilder.Entity<LiquidacionDetalleImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionDetalleImpuesto_Indice");
        ...
        modelBuilder.Entity<LiquidacionInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionInfoAdicional_Indice");
        ...
        {
            entity.HasKey(e => e.CiLiquidacionreembolso).HasName("PK__Liquidac__2D164316770379CB");

            entity.ToTable("LiquidacionReembolso");

            entity.HasIndex(e => new { e.EstabDocReembolso, e.PtoEmiDocReembolso, e.SecuencialDocReembolso, e.CiCompania }, "IX_LiquidacionReembolso_Indice");
        ...
        modelBuilder.Entity<LiquidacionTotalImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_LiquidacionTotalImpuesto_Indice");
        ...
        modelBuilder.Entity<NotaCredito>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_NotaCredito_Indice");
        ...
        modelBuilder.Entity<NotaCreditoDetalle>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaCreditoDetalle_Indice");
        ...
        modelBuilder.Entity<NotaCreditoDetalleAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaCreditoDetalleAdicional_Indice");
        ...
        modelBuilder.Entity<NotaCreditoDetalleImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaCreditoDetalleImpuesto_Indice");
        ...
        modelBuilder.Entity<NotaCreditoInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaCreditoInfoAdicional_Indice");
        ...
        modelBuilder.Entity<NotaCreditoTotalImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaCreditoTotalImpuesto_Indice");
        ...
        modelBuilder.Entity<NotaDebito>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania, e.TxClaveAcceso }, "IX_NotaDebito_Indice");
        ...
        modelBuilder.Entity<NotaDebitoImpuesto>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaDebitoImpuesto_Indice");
        ...
        modelBuilder.Entity<NotaDebitoInfoAdicional>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaDebitoInfoAdicional_Indice");
        ...
        modelBuilder.Entity<NotaDebitoMotivo>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TxEstablecimiento, e.TxPuntoEmision, e.TxSecuencial, e.CiCompania }, "IX_NotaDebitoMotivo_Indice");
        ...
        {
            entity.HasKey(e => e.CiTipoAmbiente).HasName("PK__TipoAmbi__6AE464A0336E7355");
